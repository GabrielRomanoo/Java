...
public interface FuncionarioRepository extends CrudRepository<Funcionario, Integer> {
	...
	/* Ordenação
	Ainda vamos falar sobre ordenação e páginas, 
	mas claro que a Derived Query pode dar suporte:

	List<Funcionario> findByNomeOrderByNomeAsc(String nome); */
	
	/* Métodos longos
	E como dica, como definimos os critérios de pesquisa por meio do nome do método, 
	precisamos ter cuidado para não criar nomes gigantes e prejudicar a legibilidade. 
	Nesse caso devemos favorecer as consultas com JPQL. */ 

	/* Documentação
	Por fim aqui está a documentação do Spring Data JPA, com mais exemplos. 
